...
public class TestData {
    ...
    public static final String EXPECTED_ARTWORK_URL = "https://is3-ssl.mzstatic.com/image/thumb/Music6/v4/0e/38/b4/0e38b405-ae2c-1da4-5959-866f7abb110e/source/100x100bb.jpg";
    ...
    public static final ArtworkRequestModel EXPECTED_ARTWORK = getArtwork();
    public static final PreviewRequestModel EXPECTED_M4A_PREVIEW = getAudioPreview();
    public static final PreviewRequestModel EXPECTED_M4V_PREVIEW = getVideoPreview();

    public static ArtworkRequestModel getArtwork() {
        return new ArtworkRequestModel(getFileBytes("artwork.jpg"));
    }

    private static PreviewRequestModel getAudioPreview() {
        return new PreviewRequestModel(PreviewRequestModel.Type.M4A, getFileBytes("preview.m4a"));
    }

    private static PreviewRequestModel getVideoPreview() {
        return new PreviewRequestModel(PreviewRequestModel.Type.M4A, getFileBytes("preview.m4v"));
    }
